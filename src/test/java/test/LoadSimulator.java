 ...
 * 
 * Set and check test properties at {@link src
 * /test/resources/loadtest.properties}
 */
public class LoadSimulator {
	...
	public static void main(String[] args) throws Exception {
		...
		IProxyCli proxy = comp.startProxy(new Config("proxy"), new Shell(
				"proxy", System.out, testInput));
		IFileServerCli fs1 = comp.startFileServer(new Config("fs1"), new Shell(
				"fs1", System.out, testInput));
		IFileServerCli fs2 = comp.startFileServer(new Config("fs2"), new Shell(
				"fs2", System.out, testInput));
		IFileServerCli fs3 = comp.startFileServer(new Config("fs3"), new Shell(
				"fs3", System.out, testInput));
		IFileServerCli fs4 = comp.startFileServer(new Config("fs4"), new Shell(
				"fs4", System.out, testInput));
