...
public class FileGenerator {
    ...
    public final int UTF8_RANGE_MIN = 0x30; // '0' range of alpha-numerical
    public final int UTF8_RANGE_MAX = 0x7E; // '~' values
    ...
    public void generateRandomFile(String directory, String name, int size) {
        ...
        for (int i = 0; i < content.length; i++) {
            content[i] = (char) ((Math.abs(random.nextInt()) % (UTF8_RANGE_MAX - UTF8_RANGE_MIN + 1)) + UTF8_RANGE_MIN);
        }
    ...
    public void resetDirectories() {
        ...
        deleteAllFilesOfDirectoryExcept("files/fileserver1", "long.txt", "short.txt", "multiline.txt");
        deleteAllFilesOfDirectoryExcept("files/fileserver2", "long.txt", "short.txt", "multiline.txt");
        deleteAllFilesOfDirectoryExcept("files/fileserver3", "long.txt", "short.txt", "multiline.txt");
        deleteAllFilesOfDirectoryExcept("files/fileserver4", "long.txt", "short.txt", "multiline.txt");
    }

    private void deleteAllFilesOfDirectoryExcept(String directory, String... exceptions) {
